                    ...
                    <form action="{{ route('admin.branches.update', $branch) }}" method="POST">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="code" name="code" type="text" class="mt-1 block w-full" :value="old('code', $branch->code)" required autofocus />
                            ...
                            <div>
                                ...
                                <textarea id="address" name="address" rows="3"
                                    class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm">{{ old('address', $branch->address) }}</textarea>
